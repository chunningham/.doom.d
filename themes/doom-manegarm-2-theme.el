;;; themes/doom-manegarm-2-theme.el -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-manegarm-2-theme nil
  "Options for the `doom-manegarm-2' theme."
  :group 'doom-themes)

(defcustom doom-manegarm-2-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-manegarm-2-theme
  :type '(choice integer boolean))

(defcustom doom-manegarm-2-muted-modeline nil
...
(defcustom doom-manegarm-2-darker-background nil
...
(def-doom-theme doom-manegarm-2
  ...
  (
   ...
   (bg         (if doom-manegarm-2-darker-background -bg-alt -bg))
   (bg-alt     (if doom-manegarm-2-darker-background -bg -bg-alt))
   ...
   (-modeline-pad
    (when doom-manegarm-2-padded-modeline
      (if (integerp doom-manegarm-2-padded-modeline) doom-manegarm-2-padded-modeline 4)))

   (modeline-fg     green)
   (modeline-fg-alt vertical-bar)

   (modeline-bg
    `(,(car (if doom-manegarm-2-muted-modeline (doom-darken teal 0.75) (doom-darken green 0.8)))
      ,@(cdr base0)))
...
;;; doom-manegarm-2-theme.el ends here
